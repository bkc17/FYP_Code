...
class ProcessPlotter:
    ...
    def __call__(self, pipe):
        ...
        # timer = Timer(0.2, self.call_back)
        # timer.start()
...
class NBPlot:
    ...
    def plot(self, finished=False):
        ...
        if finished:
            ...
            temp = self.device.char_read("F000BEF104514000B000000000000000")
            rot_speed = self.device.char_read("F000BEEF04514000B000000000000000")
            grad = self.device.char_read("F000BEF004514000B000000000000000")
            vdd = self.device.char_read("F000BEF204514000B000000000000000")
