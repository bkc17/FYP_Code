/** \mainpage Driver Overview
  ...
  * - <b>Created</b>:          2022-02-14 14:50:15.469
  ...
  *     - <b>O: Disable the BQ25505 chip</b>: DIO11
  *     - <b>O: enable vdd hold</b>: DIO3
  *
  *
...
/// compHandle I/O mapping: Disable the BQ25505 chip
#define SCIF_COMP_HANDLE_DIO_O_BQDISABLE 11
/// compHandle I/O mapping: enable vdd hold
#define SCIF_COMP_HANDLE_DIO_O_VDDHOLD 3
...
/// compHandle: Task input data structure
typedef struct {
    uint16_t RotationEnable; ///< Enable the rotation calculation
    uint16_t TempEnable;     ///< Enables the code to read the temperature
} SCIF_COMP_HANDLE_INPUT_T;
...
typedef struct {
    struct {
        SCIF_COMP_HANDLE_INPUT_T input;
