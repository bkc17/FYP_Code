...
.dlls,em3 .dlls: app_uartlog.pem3

-include package/cfg/app_uartlog_pem3.mak
-include package/cfg/app_uartlog_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/app_uartlog_pem3.dep
endif
app_uartlog.pem3: package/cfg/app_uartlog_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
app_uartlog.pem3 package/cfg/app_uartlog_pem3.c: .libraries,em3
endif

package/cfg/app_uartlog_pem3.c package/cfg/app_uartlog_pem3.h package/cfg/app_uartlog_pem3.xdl: override _PROG_NAME := app_uartlog.xem3
package/cfg/app_uartlog_pem3.c: package/cfg/app_uartlog_pem3.cfg
package/cfg/app_uartlog_pem3.xdc.inc: package/cfg/app_uartlog_pem3.xdl
package/cfg/app_uartlog_pem3.xdl package/cfg/app_uartlog_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/app_uartlog_pem3.cfg
	-$(RM) package/cfg/app_uartlog_pem3.dep
	-$(RM) package/cfg/app_uartlog_pem3.c
	-$(RM) package/cfg/app_uartlog_pem3.xdc.inc

clean,em3::
	-$(RM) app_uartlog.pem3
.executables,em3 .executables: app_uartlog.xem3

app_uartlog.xem3: |app_uartlog.pem3

-include package/cfg/app_uartlog.xem3.mak
app_uartlog.xem3: package/cfg/app_uartlog_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/app_uartlog_pem3.oem3   package/cfg/app_uartlog_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
app_uartlog.xem3: export C_DIR=
app_uartlog.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
app_uartlog.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

app_uartlog.test test,em3 test: app_uartlog.xem3.test

app_uartlog.xem3.test:: app_uartlog.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 app_uartlog.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.app_uartlog.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,app_uartlog.xem3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
app_uartlog_pem3.oem3,copy : package/cfg/app_uartlog_pem3.oem3
app_uartlog_pem3.sem3,copy : package/cfg/app_uartlog_pem3.sem3
